...
class SSDNet(object):
    ...
    default_params = SSDParams(
        ...
        feat_shapes=[(10, 10), (5, 5), (3, 3), (2, 2), (1, 1), (1, 1)],  #[(19, 19), (10, 10), (5, 5), (3, 3), (2, 2), (1, 1)],
        anchor_size_bounds=[0.15, 0.90],
        #anchor_sizes = gen_anchor_sizes(*([0.15, 0.90] + [6] + [300])),
        # anchor_size_bounds=[0.20, 0.90],
        anchor_sizes=[(13., 24.),  # 这里没有按照原文进行实现, [16, 34, 74, 114, 155, 195, 235]
                      (24., 53.),
                      (53., 82.),
                      (82., 111.),
                      (111., 140.),
        ...
        #               [2, .5, 3, 1./3],
        #               [2, .5, 3, 1./3]],
        anchor_steps= [13, 24, 53, 82, 111, 140, 168],  #[14, 24, 53, 82, 111, 140, 168],  # scale系数计算 
        anchor_offset=0.5,
...
def ssd_net(inputs,
    ...
    with tf.variable_scope('mobilenetv2'):
        ...
        # Block 2.
        net = res_block(net, 1, 16, 1, is_training, shortcut=False, name='res2_1')
        ...
        # Block 5.
        net = res_block(net, exp, 64, 1, is_training, shortcut=False, name='res5_1')
        ...
        net = res_block(net, exp, 320, 1, is_training, shortcut=False, name='res7_4_add')
