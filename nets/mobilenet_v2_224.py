...
class SSDNet(object):
    ...
    default_params = SSDParams(
        ...
        feat_shapes=[(14, 14), (7, 7), (4, 4), (2, 2), (1, 1), (1, 1)],  #[(19, 19), (10, 10), (5, 5), (3, 3), (2, 2), (1, 1)],
        anchor_size_bounds=[0.15, 0.90],
        #anchor_sizes = gen_anchor_sizes(*([0.15, 0.90] + [6] + [300])),
        # anchor_size_bounds=[0.20, 0.90],
        anchor_sizes=[(16., 34.),  # 这里没有按照原文进行实现, [16, 34, 74, 114, 155, 195, 235]
                      (34., 74.),
                      (74., 114.),
                      (114., 155.),
                      (155., 195.),
        ...
        #               [2, .5, 3, 1./3],
        #               [2, .5, 3, 1./3]],
        anchor_steps=[12, 22, 45, 75, 112, 224],  #[16, 30, 60, 100, 150, 300],  # scale系数计算 
        anchor_offset=0.5,
