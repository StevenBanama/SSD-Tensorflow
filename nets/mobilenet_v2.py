...
class SSDNet(object):
    ...
    default_params = SSDParams(
        ...
        feat_layers=['block4', 'block6', 'block7', 'block8', 'block9', 'block11'],
...
def ssd_net(inputs,
    ...
    with tf.variable_scope('mobilenetv2'):
        ...
        # Block 7.
        net = res_block(net, exp, 160, 2, is_training, name='res7_1')  # size/32, 16
        ...
        for i in xrange(1, 12):
            print(str(i), end_points["block"+str(i)].shape)
