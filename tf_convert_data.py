...
from datasets import pascalvoc_to_tfrecords, pascal_hand
...
def main(_):
    ...
    elif FLAGS.dataset_name == 'hand':
        pascal_hand.run(FLAGS.dataset_dir, FLAGS.output_dir, FLAGS.output_name)
    else:
